...
class command_labview:
    ...
    def exchange_time(self, time_str):
        ...
        send_str = struct.pack(format_str,6,l,time_str) #command 6 corresponds to sending and getting Labview time
    ...
    def start_collecting(self,filename):
        ...
        l = len(filename)
        format_str = "BB"+str(l)+"s"
        start_str = struct.pack(format_str,7,l,filename) # Command 7 corresponds to start labview recording
